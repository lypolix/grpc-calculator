...
const file_adder_proto_rawDesc = "" +
	"\n" +
	"\vadder.proto\x12\x03api\x1a\x1cgoogle/api/annotations.proto\"(\n" +
	"\n" +
	"AddRequest\x12\f\n" +
	...
	"\x05Adder\x12<\n" +
	"\x03Add\x12\x0f.api.AddRequest\x1a\x10.api.AddResponse\"\x12\x82\xd3\xe4\x93\x02\f:\x01*\"\a/v1/addB,Z*github.com/lypolix/grpc-calculator/pkg/apib\x06proto3"
